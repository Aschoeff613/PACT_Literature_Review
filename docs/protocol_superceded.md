...
Map surface labels to canonical constructs in a synonym table, keeping original labels so merges can be checked. Classify every canonical construct by altitude, which feeds the Stanford-Erasmus crosswalk directly.
